...
<div className="mb-3">
    ...
    <input type="text" className="form-control" id="userId" name="userId" placeholder="your user Id" />
    </div>
  ...
  <div className="mb-3">
    ...
    <textarea  type="text" rows="4" className="form-control" name="body" id="body" placeholder="Tell us more about it" />
    </div>
